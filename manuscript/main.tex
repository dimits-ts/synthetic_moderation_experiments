...
\newcommand{\syndisco}{\showifnotreview{``SynDisco''}}
\newcommand{\pip}{\showifnotreview{\texttt{(pip install syndisco)}}}
\newcommand{\vmd}{\showifnotreview{the ``\ac{VMD}'' }}
\newcommand{\projectlink}{\showifnotreview{\footnote{\url{https://github.com/dimits-ts/synthetic_discussion_framework}}}}
\newcommand{\datasetlink}{\showifnotreview{\footnote{\url{https://paperswithcode.com/dataset/vmd}}}}
\newcommand{\analysislink}{\showifnotreview{\footnote{\url{https://github.com/dimits-ts/synthetic_moderation_experiments}}}}
