...
We introduce\syndisco\syndiscolink an open-source, lightweight, purpose-built framework for generating synthetic discussions. The key features of the framework are: 
